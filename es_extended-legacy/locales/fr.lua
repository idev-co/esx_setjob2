Locales['fr'] = {
  ...
  ['received_salary2'] = 'vous avez reçu votre second salaire: ~g~$%s~s~',
  ...
  ['received_paycheck2'] = 'paiement reçu (2ème job)',
  ['bank'] = 'banque',
  ['account_bank'] = 'banque',
  ...
  ['command_setjob_job2'] = 'nom du job2',
  ['command_setjob_grade'] = 'grade du job',
  ['command_setjob_grade2'] = 'grade du job2',
  ['command_setjob_invalid'] = 'le job, le grade ou les deux sont invalides',
  ['command_setjob_invalid2'] = 'le job2, le grade ou les deux sont invalides',
