Locales['fr'] = {
  ...
  ['received_salary2'] = 'vous avez reçu votre 2ème salaire: ~g~$%s~s~',
  ['company_nomoney2'] = 'votre 2ème entreprise n\'a plus d\'argent pour vous payer!',
  ['received_paycheck2'] = 'paiement reçu (Second Job)',
  ['bank'] = 'banque',
  ['account_bank'] = 'banque',
